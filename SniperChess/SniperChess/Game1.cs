...
namespace SniperChess
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            King bk = new King(spriteBatch, B_KingTex, new Vector2(4, 0));
            Queen bq = new Queen(spriteBatch, B_QueenTex, new Vector2(3, 0));
            Bishop bb1 = new Bishop(spriteBatch, B_BishopTex, new Vector2(2, 0));
            Bishop bb2 = new Bishop(spriteBatch, B_BishopTex, new Vector2(5, 0));
            Knight bk1 = new Knight(spriteBatch, B_KnightTex, new Vector2(1, 0));
            Knight bk2 = new Knight(spriteBatch, B_KnightTex, new Vector2(6, 0));
            Rook br1 = new Rook(spriteBatch, B_RookTex, new Vector2(0, 0));
            Rook br2 = new Rook(spriteBatch, B_RookTex, new Vector2(7, 0));
            Pawn bp1 = new Pawn(spriteBatch, B_PawnTex, new Vector2(0, 1));
            Pawn bp2 = new Pawn(spriteBatch, B_PawnTex, new Vector2(1, 1));
            Pawn bp3 = new Pawn(spriteBatch, B_PawnTex, new Vector2(2, 1));
            Pawn bp4 = new Pawn(spriteBatch, B_PawnTex, new Vector2(3, 1));
            Pawn bp5 = new Pawn(spriteBatch, B_PawnTex, new Vector2(4, 1));
            Pawn bp6 = new Pawn(spriteBatch, B_PawnTex, new Vector2(5, 1));
            Pawn bp7 = new Pawn(spriteBatch, B_PawnTex, new Vector2(6, 1));
            Pawn bp8 = new Pawn(spriteBatch, B_PawnTex, new Vector2(7, 1));
            ...
            King wk = new King(spriteBatch, W_KingTex, new Vector2(4, 7));
            Queen wq = new Queen(spriteBatch, W_QueenTex, new Vector2(3, 7));
            Bishop wb1 = new Bishop(spriteBatch, W_BishopTex, new Vector2(2, 7));
            Bishop wb2 = new Bishop(spriteBatch, W_BishopTex, new Vector2(5, 7));
            Knight wk1 = new Knight(spriteBatch, W_KnightTex, new Vector2(1, 7));
            Knight wk2 = new Knight(spriteBatch, W_KnightTex, new Vector2(6, 7));
            Rook wr1 = new Rook(spriteBatch, W_RookTex, new Vector2(0, 7));
            Rook wr2 = new Rook(spriteBatch, W_RookTex, new Vector2(7, 7));
            Pawn wp1 = new Pawn(spriteBatch, W_PawnTex, new Vector2(0, 6));
            Pawn wp2 = new Pawn(spriteBatch, W_PawnTex, new Vector2(1, 6));
            Pawn wp3 = new Pawn(spriteBatch, W_PawnTex, new Vector2(2, 6));
            Pawn wp4 = new Pawn(spriteBatch, W_PawnTex, new Vector2(3, 6));
            Pawn wp5 = new Pawn(spriteBatch, W_PawnTex, new Vector2(4, 6));
            Pawn wp6 = new Pawn(spriteBatch, W_PawnTex, new Vector2(5, 6));
            Pawn wp7 = new Pawn(spriteBatch, W_PawnTex, new Vector2(6, 6));
            Pawn wp8 = new Pawn(spriteBatch, W_PawnTex, new Vector2(7, 6));
